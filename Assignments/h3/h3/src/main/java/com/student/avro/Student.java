...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.student.avro.Student.Builder newBuilder() {
    return new com.student.avro.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.student.avro.Student.Builder newBuilder(com.student.avro.Student.Builder other) {
    if (other == null) {
      return new com.student.avro.Student.Builder();
    } else {
      return other;
   ...
   * @return A new Student RecordBuilder
   */
  public static com.student.avro.Student.Builder newBuilder(com.student.avro.Student other) {
    if (other == null) {
      return new com.student.avro.Student.Builder();
    } else {
      return new com.student.avro.Student.Builder();
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.student.avro.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.student.avro.Student other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.filename)) {
        this.filename = data().deepCopy(fields()[0].schema(), other.filename);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.student.avro.Student.Builder setFilename(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.student.avro.Student.Builder clearFilename() {
      filename = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.student.avro.Student.Builder setFilecontent(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.student.avro.Student.Builder clearFilecontent() {
      filecontent = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.student.avro.Student.Builder setChecksum(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.student.avro.Student.Builder clearChecksum() {
      checksum = null;
